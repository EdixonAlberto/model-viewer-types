  ...
  interface IntrinsicElements {
    'model-viewer': ModelViewer &
      Partial<{
        ...
        style: object
        ref: object
        // TODO: Agregar algunos types para las props de react
        // React.MutableRefObject<import('@google/model-viewer/lib/model-viewer').ModelViewerElement | undefined>
      }>
  }
}
...
declare type ModelViewerRef = ModelViewer & {
  setAttribute(attr: string, value: string): void
  addEventListener(evt: string, clb: CallableFunction): void
  removeEventListener(evt: string, clb: CallableFunction): void
}
